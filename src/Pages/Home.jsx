...
const WORDS = ["Problem Solver", "Visionary", "Driven"];
const TECH_STACK = ["Python", "Javascript", "AI", "Microsoft Azure"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/LifeMystery" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/lebo-aphane/" },
  { icon: Instagram, link: "https://www.instagram.com/phenomenalamateur/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Designing and building robust, efficient systems that streamline processes, optimize performance, and drive seamless user and business experiences.
                </p>
